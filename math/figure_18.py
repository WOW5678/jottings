# -*- coding: utf-8 -*-
"""
 @Time    : 2018/11/6 0006 上午 9:14
 @Author  : Shanshan Wang
 @Version : Python3.5
 @Function: 弄清matplotlob figure中各个元素的含义
"""
...
#设置图标的显示风格
#['fivethirtyeight', 'seaborn-dark-palette', 'seaborn-whitegrid', 'seaborn-colorblind', 'seaborn-talk', 'classic', 'seaborn-darkgrid', 'seaborn-pastel', 'seaborn-bright', 'seaborn-white', 'seaborn-deep', 'seaborn-poster', 'seaborn-notebook', 'bmh', 'grayscale', 'ggplot', 'tableau-colorblind10', 'seaborn-dark', 'fast', 'seaborn', 'seaborn-paper', 'Solarize_Light2', 'seaborn-muted', 'seaborn-ticks', 'dark_background', '_classic_test']
...
plt.title(u'我是标题')
# plt.text(-3, -3, '$y=sin(x)[/align][/size][/font][/align]'
# , fontsize=20, bbox={'facecolor': 'yellow', 'alpha': 0.2})
